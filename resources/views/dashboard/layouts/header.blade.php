    ...
    <aside class="navbar-aside" id="offcanvas_aside">
        <div class="aside-top">
            <a href="index.html" class="brand-wrap">
                <img src="{{ asset('evara-backend/assets/imgs/theme/logo.svg')}}" class="logo" alt="Evara Dashboard">
            </a>
            <div>
        ...
        <nav>
            <ul class="menu-aside">
                ...
                <li class="menu-item ">
                    <a class="menu-link" href="/admin/slider"> <i class="icon material-icons md-store"></i>
                        <span class="text">
                            Sliders
                        </span>
                    </a>
